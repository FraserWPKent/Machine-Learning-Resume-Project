...
def main():
    ...
    trainingLoader = DataLoader(trainingDataset, shuffle=True, batch_size=32, num_workers=4)
    testingLoader = DataLoader(testingDataset, shuffle=False, batch_size=32, num_workers=4)
    ...
    training.trainingLoop(trainingLoader=trainingLoader, validationLoader=trainingLoader)
